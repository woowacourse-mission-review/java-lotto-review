...
class WinningLottoTest {
    ...
    void generate_winning_lotto() {
        assertDoesNotThrow(() -> WinningLotto.of(parse(1, 2, 3, 4, 5, 6), LottoNo.of(7)));
    }
    ...
    void generate_winning_lotto_winning_no_contains_bonus_no() {
        WinningNoContainsBonusNoException e = assertThrows(WinningNoContainsBonusNoException.class,
                () -> WinningLotto.of(parse(1, 2, 3, 4, 5, 6), LottoNo.of(6)));
    ...
    void compare_match_no() {
        ...
        WinningLotto winningLotto = WinningLotto.of(parse(1, 2, 3, 4, 7, 8), LottoNo.of(10));
    ...
    void match_bonus_no() {
        Lotto lotto = Lotto.of(parse(1, 2, 3, 4, 5, 6));
        WinningLotto winningLotto = WinningLotto.of(parse(1, 2, 3, 4, 7, 8), LottoNo.of(6));
    ...
    void not_match_bonus_no() {
        Lotto lotto = Lotto.of(parse(1, 2, 3, 4, 5, 6));
        WinningLotto winningLotto = WinningLotto.of(parse(1, 2, 3, 4, 7, 8), LottoNo.of(9));
